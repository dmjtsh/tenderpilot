...
from .views import TenderViewSet, TenderPipelineViewSet, RegionsListView, PlatformsListView, OkvedSearchView, CustomerSearchView, TenderSitemapView
...
urlpatterns = [
    ...
    path("platforms/", PlatformsListView.as_view(), name="tenders-platforms"),
