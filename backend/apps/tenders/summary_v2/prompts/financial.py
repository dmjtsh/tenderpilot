...
КАССОВЫЙ ХАРАКТЕР:
- Если нет аванса И длительность работ > 180 дней → отметь как "высокая нагрузка на оборотный капитал"
- Если оплата только в конце → "выраженный кассовый риск"
- Сформулируй итог в поле cash_flow_note
