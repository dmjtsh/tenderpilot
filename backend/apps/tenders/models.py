...
class Tender(models.Model):
    ...
    class Industry(models.TextChoices):
        CONSTRUCTION_MATERIALS = "construction_materials", "Материалы и изделия"
        CONSTRUCTION_WORKS = "construction_works", "Строительные работы"
        MEDICINE = "medicine", "Медицина и фармацевтика"
        IT = "it", "IT и электроника"
        FOOD = "food", "Продовольствие и общепит"
        EQUIPMENT = "equipment", "Оборудование и техника"
        ENERGY = "energy", "Энергия, ГСМ и ЖКХ"
        CHEMISTRY = "chemistry", "Химия и моющие средства"
        PAPER = "paper", "Бумага и полиграфия"
        AGRICULTURE = "agriculture", "Сельское хозяйство"
        TEXTILE = "textile", "Текстиль, одежда и обувь"
