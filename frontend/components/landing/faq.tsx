...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Мы используем семантический поиск, а не простое совпадение по ключевым словам. Вы настраиваете направления с ОКВЭД, регионами и диапазоном НМЦ, и система подбирает тендеры по смыслу вашей деятельности. Чем точнее заполнен профиль, тем релевантнее подборка.",
  },
  {
