...
const INDUSTRY_OPTIONS = [
  ...
  { value: "it", label: "IT и электроника" },
  { value: "food", label: "Продовольствие и общепит" },
  { value: "equipment", label: "Оборудование и техника" },
  { value: "energy", label: "Энергия, ГСМ и ЖКХ" },
  { value: "chemistry", label: "Химия и моющие средства" },
  { value: "paper", label: "Бумага и полиграфия" },
  { value: "agriculture", label: "Сельское хозяйство" },
  { value: "textile", label: "Текстиль, одежда и обувь" },
